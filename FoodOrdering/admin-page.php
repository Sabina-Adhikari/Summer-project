        ...
        <div class="navbar-fixed">
            <nav class="navbar-color">
                <div class="nav-wrapper">
                     <ul class="left">                      
                      <li><h1 class="logo-wrapper"><a href="index.php" class="brand-logo darken-1"><img src="images/fast.jpg" alt="logo"></a> <span class="logo-text">Logo</span></h1></li>
                    </ul> 
                    </ul>
            <ul class="center"  ><span class="center"> THE SEASONS 52 FAST FOOD CAFE<a class="grey-text text-lighten-4" href="#"></a></span></ul>
                </div>
            </nav>
        </div>
        <!-- end header nav-->
  ...
  <!-- START FOOTER -->
   <footer class="page-footer">
    <div class="footer-copyright">
      <div class="container">
        <span>
kadaghari, pepsicola<a class="grey-text text-lighten-4" href="#" target="_blank"></a> </span>
        <span class="right"> 
Call 986-0703632 <a class="grey-text text-lighten-4" href="#"></a></span>
        </div>
    </div>
  </footer>
    <!-- END FOOTER -->
